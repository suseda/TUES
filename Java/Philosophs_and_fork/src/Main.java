...
//                throw new RuntimeException(e);
        ...
        public void run() {
            ...
            try {
                while (true) {
                    ...
                    Thread.sleep(1000);
                    System.out.println(getName() + " is passing the fork");
                    next.giveFork(fork);
                    fork = null;
                }
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        ph.add(new Philospher("Sokrat"));
        ph.add(new Philospher("Platon"));
        ph.add(new Philospher("Aristotel"));
        ph.add(new Philospher("Efklit"));
